                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                <p class="fs-4 text-white animated zoomIn"> Selamat Datang <strong class="text-dark">JeWePe Wedding</strong></p>
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Mengabadikan Setiap Momen
                                    pernikahan anda</h1>
                            </div>
                        </div>
                    </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            ...
            <h1 class="display-6">Pilih Paket Pernikahan Sesuai Kebutuhanmu dan Pasangan</h1>
        </div>
        <div class="row g-4">
