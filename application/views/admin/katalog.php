                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            <a href="<?= base_url('admin/Katalog/add') ?>" class="btn btn-primary">Tambahan Data</a>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="table-responsive pt-3">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $getAllKatalog = $this->db->get('tb_catalogues')->result(); // Fetch as objects
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?= base_url('admin/katalog/delete?id=') . $row->catalogue_id ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="if (! confirm('Apakah anda yakin akan menghapus katalog ini ??')) {return false;}">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
